/* Question: Ek program likhein jo structures aur date differences ka use karke un employees ko dhundhe jo > 3 saal se kaam kar rahe hain aur unki salary < 21600 hai. */

#include <stdio.h>
#include <time.h>

// Employee aur Date ke liye structures define karein
...
// Kisi bhi mahine me dino ki sankhya (number of days) calculate karne ke liye function
int daysInMonth(int month, int year)
{
    ...
    case 4: case 6: case 9: case 11:
        return 30;
    case 2:
        // Leap year ke liye check karein
...
// Do dates ke beech dino ka difference calculate karne ke liye function
...
int main(void)
{
    ...
    // Difference calculate karein aur criteria match karne wale employees ko display karein
